'''
this code makes list of list based on the time difference
odd numbred list contains data till significant time difference occurs
    ...
    for data in x:
        try:
            ...
            current_data = {
                ...
                "speed": speed,
                "heading": heading,
                "time_difference": None if previous_timestamp is None else (timestamp - previous_timestamp).total_seconds()
            }
